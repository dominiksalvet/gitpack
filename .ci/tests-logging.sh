...
echo test14 >&2 && test "$(grep -c '\[refresh\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 4 &&
...
echo test28 >&2 && test "$(grep -c '\[refresh\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 8 &&
...
echo test44 >&2 && test "$(grep -c '\[refresh\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 12 &&
...
echo test60 >&2 && test "$(grep -c '\[refresh\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 15 &&
...
echo test76 >&2 && test "$(grep -c '\[refresh\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 15 &&
...
echo test91 >&2 && test "$(grep -c '\[action\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 16 &&
echo test92 >&2 && test "$(grep -c '\[url\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 16 &&
echo test93 >&2 && test "$(grep -c '\[refresh\]' "$HOME"/.local/share/gitpack/gitpack.log)" -eq 15 &&
